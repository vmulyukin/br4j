...
public class PostHTTPRequest {
	 ...
	 * @throws IOException
	 */
	public PostHTTPRequest(URLConnection connection) throws IOException {
	...
	/**
	 * Creates a new simple POST HTTP request on a freshly opened URLConnection
	 * 
	 * @param connection
	 *            an already open URL connection
	 * @throws IOException
	 */
	public PostHTTPRequest(URLConnection connection, String contentType)
			throws IOException {
		this.connection = connection;
		connection.setDoOutput(true);
	 ...
	 * @throws IOException
	 */
	public PostHTTPRequest(URL url) throws IOException {
	 ...
	 * @throws IOException
	 */
	public PostHTTPRequest(URL url, String contentType) throws IOException {
		this(url.openConnection(), contentType);
	}
	 ...
	 * @throws IOException
	 */
	public PostHTTPRequest(String urlString) throws IOException {
	...
	public void setParameter(String name, String filename, InputStream is)
			throws IOException {
		String fFileName = new String(filename.getBytes("UTF-8"));
	...
	public void setParameter(String name, File file) throws IOException {
		...
		AccessController.doPrivileged(new PrivilegedAction() {
			public Object run() {
				try {
					setParameter(fName, fFile.getPath(), new FileInputStream(
							fFile));
				} catch (Exception e) {
					e.printStackTrace();
				} finally {
	...
	public InputStream post() throws IOException {
		...
		writeln("--");
		os.close();
		final InputStream inpStr = AccessController
				.doPrivileged(new PrivilegedAction<InputStream>() {
					public InputStream run() {
						InputStream retVal = null;
						try {
							retVal = connection.getInputStream();
						} catch (Exception e) {
							e.printStackTrace();
						} finally {
							return retVal;
	...
	public InputStream postString() throws IOException {
		os.close();
		final InputStream inpStr = AccessController
				.doPrivileged(new PrivilegedAction<InputStream>() {
					public InputStream run() {
	...
	public InputStream postFormFields() throws IOException {
		os.close();
		final InputStream inpStr = AccessController
				.doPrivileged(new PrivilegedAction<InputStream>() {
					public InputStream run() {
	...
	public static InputStream post(URL url, Map parameters) throws IOException {
		return new PostHTTPRequest(url).post(parameters);
	}
	...
	public static InputStream post(URL url, Map cookies, Map parameters)
			throws IOException {
		return new PostHTTPRequest(url).post(cookies, parameters);
	}
	...
	public static InputStream post(URL url, String name1, Object value1)
			throws IOException {
		return new PostHTTPRequest(url).post(name1, value1);
	}
	...
	public static InputStream post(URL url, String name1, Object value1,
		...
		return new PostHTTPRequest(url).post(name1, value1, name2, value2);
	}
	...
	public void setPostField(String paramName, String paramVal) {
		try {
			fieldsTable.put(paramName, paramVal);
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	public String getSimplePostString() throws IOException {
		String resString = null;
		String retVal = "";
		Enumeration tableKeys = fieldsTable.keys();
		String key = null;
		String val = null;
		while (tableKeys.hasMoreElements()) {
			// System.out.println(tableKeys.nextElement());
			key = (String) tableKeys.nextElement();
			val = (String) fieldsTable.get(key);
