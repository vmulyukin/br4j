...
public class OnExecutionContWorkstationQuery extends JdbcDaoSupport {
	...
	private static StringBuilder buildSupervisorQuery( boolean count, int userId, long[] permissionTypes, 
        ...
        sql.append( "select avMain.number_value from card cp  " );
        sql.append( "inner join attribute_value vp on (vp.card_id = cp.card_id) " );
        sql.append( "inner join attribute_value vpC on (vpC.card_id = cp.card_id)  " );
        ...
        sql.append( "and vpC.attribute_code = 'JBR_TCON_ONCONT' " );
        sql.append( "and vpC.value_id = 1449 " );
        ...
        // orders in status 'execution' with ARM manager as signer
        sql.append( "select cp.card_id from card cp " );
        sql.append( "inner join attribute_value vp on (vp.card_id = cp.card_id) " );
        sql.append( "inner join attribute_value vpC on (vpC.card_id = cp.card_id)  " );
        ...
        sql.append( "and vpC.attribute_code = 'JBR_IMPL_ONCONT' " );
        sql.append( "and vpC.value_id = 1432 " );
        sql.append( "and not exists (select 1 from attribute_value where card_id = cp.card_id and attribute_code = 'JBR_ARM_HIDE' and value_id = 1449) ");
