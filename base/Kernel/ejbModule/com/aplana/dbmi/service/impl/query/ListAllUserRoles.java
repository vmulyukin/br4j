...
/**
 * {@link ChildrenQueryBase} descendant used to fetch all {@link Role roles} 
 * defined for given parent {@link Person} object.
 */
public class ListAllUserRoles extends ChildrenQueryBase
{
	/**
	 * Fetches all {@link Role roles} (both ungrouped and grouped) defined for given parent {@link Person} object.
	 * @return list containing {@link Role} objects representing set of roles assigned
