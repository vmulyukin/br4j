...
/**
 * {@link ObjectQueryBase} descendant used to fetch single {@link UngroupedRole} instance from database
 */
public class GetUngroupedUserRole extends ObjectQueryBase {
		...
		return getJdbcTemplate().queryForObject(
				...
				new RowMapper() {
					public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
						UngroupedRole role = new UngroupedRole();
