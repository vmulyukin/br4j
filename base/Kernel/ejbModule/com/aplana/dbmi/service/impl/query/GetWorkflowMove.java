...
/**
 * {@link ObjectQueryBase} descendant used to fetch single {@link WorkflowMove} instance from database
 */
public class GetWorkflowMove extends ObjectQueryBase {
	/**
	 * Fetches single {@link WorkflowMove} instance from database
	 * @return fetched {@link WorkflowMove} instance
	 */
	public Object processQuery() throws DataException {
		...
		String sql = "select wm.wfm_id, wm.name_rus, wm.name_eng, wm.need_confirmation, wm.from_status_id" +
			...
			" where wm.wfm_id = ? and wm.to_status_id = cs.status_id"; 
