...
/**
 * This access checker is used to detemine if user allowed to change
 * settings of distrinbution lists.<br>
 * Permits access for distribution lists for users with editor or
 * administrator role only.  
 */
public class DistributionAccess extends AccessCheckerBase
{
