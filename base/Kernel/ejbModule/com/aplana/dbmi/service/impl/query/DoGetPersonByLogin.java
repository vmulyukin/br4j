...
/**
 * Query used to get {@link Person} by login
 */

public class DoGetPersonByLogin extends ActionQueryBase {
    ...
    protected String getSqlQuery() {
        ...
        "FROM person p " +
        "WHERE p.is_active=1 AND p.person_login = ?";
	...
	{
		return new Object[] {
			((GetPersonByLogin)getAction()).getLogin()
		};
	}
