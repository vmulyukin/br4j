...
public class CachingQuery extends QueryBase implements CacheableEx {
	private static final long serialVersionUID = 1L;
	private static Cloner cloner = null;
	private QueryBase delegate;
	private int lifeTime;
	private long timestamp;
	private int size;
	
	public CachingQuery(QueryBase delegate, int lifeTime) {
		if (delegate == null)
	...
	public void setFilter(Filter filter) throws DataException {
		throw new RuntimeException("Filtered queries caching not supported");
	}
	...
	public Object processQuery() throws DataException {
		logger.info("List objects by " + delegate.getClass().getSimpleName());
	...
	public boolean equals(Object obj) {
		if (obj == null || !getClass().equals(obj.getClass()))
			return false;
		return delegate.getClass().equals(((CachingQuery) obj).delegate.getClass());
	}
