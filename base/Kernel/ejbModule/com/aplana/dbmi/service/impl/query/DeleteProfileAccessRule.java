...
public class DeleteProfileAccessRule extends DeleteAccessRule {
	...
	public Object processQuery() throws DataException {
		manager.cleanAccessListByRule(getId());
		getJdbcTemplate().update(
				"DELETE FROM profile_access_rule WHERE rule_id=?",
				new Object[] { getId().getId() });
		deleteOperationAndRule(getId());
		return null;
	}
