...
/**
 * Represents  attribute value mapper for {@link CardLinkAttribute}
 *  
 * @author skashanski
 *
 */

public class CardLinkAttributeValueMapper extends
		LinkAttributeValueMapper<CardLinkAttribute> {

	@Override
	protected CardLinkAttribute createAttribute() {
		return new CardLinkAttribute();
	}
