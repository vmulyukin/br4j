...
/**
 * Query used to fetch all {@link ListAttribute} instances defined in database 
 */
public class ListListAttributes extends QueryBase
{
	/**
	 * Fetches all {@link ListAttribute} instances defined in database
	 * @return list containing all {@link ListAttribute} instances defined in database
	 */
	public Object processQuery() throws DataException
	{
		return getJdbcTemplate().query(
				...
				"WHERE data_type=?",
				new Object[] { AttributeOptions.REFERENCE, AttributeTypes.LIST },
				new RowMapper() {
