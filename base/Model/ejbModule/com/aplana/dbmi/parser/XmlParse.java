 ...
 */
package com.aplana.dbmi.parser;
...
public class XmlParse implements ContentHandler{
	...
	private XmlParse(EventListener eventListener) {
    ...
    public static void parse(ItemTag itemTag, InputStream inputStream) throws Exception{
        XmlParse xmlParse = new XmlParse();
        itemTag.involveParameters(xmlParse.parse(inputStream));
    }

	
	public static void parse(String pathname, EventListener eventListener) throws Exception{
		File file = new File(pathname);
		parse(file,eventListener);
	}

	public static void parse(File file, EventListener eventListener) throws Exception {
		if (!file.isFile()) {
    ...
    public static void parse(InputStream inputStream, EventListener eventListener) throws Exception {
	...
	public static XMLReader createXmlReader(EventListener callBack)
	...
	public void characters(char[] ch, int start, int length)
		...
		if(itemTag.getMsg()!=null){
			builder = new StringBuilder(itemTag.getMsg());
		}else{
		   builder = new StringBuilder();
		}
		builder.append(ch, start, length);
		itemTag.setMsg(builder.toString());
    ...
    private ItemTag parse(InputStream inputStream) throws Exception{
        flagResult=false;
        parse(inputStream, new EventListener() {
            public void onEvent(ItemTag itemTag) {
                result = itemTag;
                flagResult=true;
            }
