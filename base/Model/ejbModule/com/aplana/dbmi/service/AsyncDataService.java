 ...
 */
public interface AsyncDataService extends javax.ejb.EJBObject
{
	/**
	 ...
	 * @throws RemoteException in case of communication error
	 */
	public Object saveObject(User user, Boolean isDelegation, User realUser, DataObject obj, ExecuteOption option, String session) throws DataException, RemoteException;
	/**
	 ...
	 * @throws RemoteException in case of communication error
	 */
	public <T> T doAction(User user, Boolean isDelegation, User realUser, Action<T> action, ExecuteOption option, String session) throws DataException, RemoteException;
	...
	public Future<Object> getResult(long id) throws DataException, RemoteException;
}
