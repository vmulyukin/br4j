...
public interface OvdAdminPortType extends java.rmi.Remote {
    ...
    /**
     * Changes the administrator password for the session manager
     */
    ...
    /**
     * Remove the news identified by its ID and returns true if the
     * operation is done
     */
