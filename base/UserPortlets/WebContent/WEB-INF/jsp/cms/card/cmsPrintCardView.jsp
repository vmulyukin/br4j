...
<% 		  
			List blocks = ((WorkstationCardPortletCardInfo)sessionBean.getActiveCardInfo()).getAttributeBlockViews();
			...
			for (ListIterator i = blocks.listIterator(); i.hasNext(); ){
			  final AttributeBlockView block = (AttributeBlockView)i.next();  		
			  
			  boolean isVisibleBlock = false;
			  for(Entry<String, AttributeView> e : block.getAttributeViews().entrySet()) {
