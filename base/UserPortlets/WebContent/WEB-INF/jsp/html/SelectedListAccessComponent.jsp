...
<%
	AccessComponent accessComponent = (AccessComponent)renderRequest.getPortletSession().getAttribute(AccessComponent.CURRENT_HANDLER);
	List list = null;
...
<form name="SelectedListForm" method="post" action="<portlet:actionURL/>">  
