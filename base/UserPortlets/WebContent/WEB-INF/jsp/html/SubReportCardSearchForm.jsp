...
<input id="cardAttachmentSubReportSearch"	type="radio" name="cardAttachmentSearchType" value="cardAttachmentSubReportSearch"
	<% if (renderRequest.getAttribute(AddSubReportCardAttachmentData.FIELD_BY_SUB_REPORT) != null) { %>checked="checked"<% } %> ></input> 
	<fmt:message key="flag.subReport"/>			
</input>
		
<input id="cardAllAttachmentSearch"	type="radio" name="cardAttachmentSearchType" value="cardAllAttachmentSearch" <% if (renderRequest.getAttribute(AddSubReportCardAttachmentData.FIELD_BY_SUB_REPORT) == null) { %>checked="checked"<% } %>>
