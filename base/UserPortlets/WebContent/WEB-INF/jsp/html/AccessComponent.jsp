...
<script Type ="text/javascript" language="javascript">
	...
	function submitFormAccessEdit(action, attributeId) {
		document.<%= accessComponent.getFormName() %>.<%= AccessComponent.ACTION_FIELD %>.value = action;	
		document.<%= accessComponent.getFormName() %>.<%= CardPortlet.ATTR_ID_FIELD %>.value = attributeId;	
	                ...
	                <tr >
                        <td>
                            <input type="checkbox" 
                                ...
                                <% if (accessComponent.isAllAccess()) { %> disabled="disabled" <% } %>
                                />
                            <label for="<%= AccessComponent.MANGER_1_ACCESS_TYPE_ID %>"><fmt:message key="access.type.manager2" /></label> 
                        </td>                       
                    </tr>
	                <tr >
                        <td>
