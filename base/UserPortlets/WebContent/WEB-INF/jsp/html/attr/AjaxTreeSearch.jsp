...
<%@page import="com.aplana.dbmi.card.AjaxTreeStateSearchEditor"%>
...
<script type="text/javascript">
	var ${attrHtmlId}_treeModel = null;
		...
		var treeStore = new dojo.data.ItemFileWriteStore({data: ${requestScope.values}});	
		...
		var values = ${requestScope.selectValues};
