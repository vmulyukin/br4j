...
<%@page import="com.aplana.dbmi.card.PortalUserLoginAttributeViewer"%>
...
String login = (String)sessionBean.getActiveCardInfo().getAttributeEditorData(attr.getId(), PortalUserLoginAttributeViewer.USER_LOGIN);
