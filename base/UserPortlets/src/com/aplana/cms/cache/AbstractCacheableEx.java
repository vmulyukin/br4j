...
abstract public class AbstractCacheableEx implements CacheableEx {
	protected Object id;
	protected Date expiration;

	protected AbstractCacheableEx(Object id) {
		if (id == null)
	...
	public boolean equals(Object obj)
	{
		if (obj == null || !obj.getClass().equals(this.getClass()))
			return false;
		return id.equals(((AbstractCacheableEx) obj).id);// obj.hashCode() == hashCode();
	}
