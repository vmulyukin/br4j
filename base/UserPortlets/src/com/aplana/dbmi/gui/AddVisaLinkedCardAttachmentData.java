...
/**
 * Provides data for getting Visa linked card attachments,assignments, execution
 * reports
 * 
 * @author skashanski
 * 
 */
public class AddVisaLinkedCardAttachmentData extends FilteredCards {
	...
	private static final String JSP_VISA_LINKED_SEARCH_PATH = "/WEB-INF/jsp/html/VisaLinkedCardSearchForm.jsp";
	...
	public AddVisaLinkedCardAttachmentData(DataServiceBean service,
			Search filter, String title) throws DataException, ServiceException {
		super(service, filter, title);
	}

	public AddVisaLinkedCardAttachmentData(Search searchFilter, Card card, CardLinkAttribute attribute, DataServiceBean service)
	...
	protected List<ObjectId> buildListDataIds(Card visa) throws DataException,
		...
		Card parentCard = getParentCard(visa);
		
		if (parentCard == null)
			return result;

		CardLinkAttribute relatDocs = parentCard
