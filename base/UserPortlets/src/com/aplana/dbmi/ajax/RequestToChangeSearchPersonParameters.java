...
import com.aplana.dbmi.portlet.RequestToChangeConsPortlet;
import com.aplana.dbmi.portlet.RequestToChangeConsPortletSessionBean;
import com.aplana.dbmi.service.DataServiceBean;

public class RequestToChangeSearchPersonParameters extends ARMSearchResultLabelBuilder implements SearchCardServletParameters {
	public static final String CALLER = "requestToChange";
	...
	public void initialize(HttpServletRequest request, DataServiceBean serviceBean) throws ServletException {
		...
		RequestToChangeConsPortletSessionBean sessionBean = 
				(RequestToChangeConsPortletSessionBean) RequestToChangeConsPortlet.getSessionBean(request, namespace);
