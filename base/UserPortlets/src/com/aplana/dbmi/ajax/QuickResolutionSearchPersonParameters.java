...
public class QuickResolutionSearchPersonParameters extends ARMSearchResultLabelBuilder implements SearchCardServletParameters {
	public static final String CALLER = "quickResolutionPortlet";
	...
	public void initialize(HttpServletRequest request, DataServiceBean serviceBean) throws ServletException {
		...
		QuickResolutionPortletSessionBean sessionBean = (QuickResolutionPortletSessionBean)QuickResolutionPortlet.getSessionBean(request, namespace);
