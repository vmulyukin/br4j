...
public class SearchMultiListAttributeInitializer extends SearchAttributeInitializer<MultiListAttribute> {
	...
	protected boolean isEmpty() {
		return attribute.getValues() == null || attribute.getValues().isEmpty();
	}
