 ...
 * @author EStatkevich
 */
public class SearchFilterStringCheckedAttributeInitializer extends SearchFilterAttributeInitializer<SearchStringCheckedAttribute, Search.TextSearchConfigValue> {

	@Override
	protected void setValue(SearchStringCheckedAttribute searchFilterAttribute, Search.TextSearchConfigValue searchAttributeValue) {
