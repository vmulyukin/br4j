...
/**
 * The editor attributes such as a linear list.
 * Displays a radio buttons choices
 * @author Agadelshin
 *
 */
public class RadioButtonAttributeEditor extends ListAttributeEditor {
	/**
	 ...
	 */
	public RadioButtonAttributeEditor() {
