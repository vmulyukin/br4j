...
public class CardLinkPickerDisabler extends DisablerBaseBuilder {
	...
	protected void addDisabler(Attribute attr, String valueAttrId, String values, boolean valuesToEnable, StringBuilder stringBuilder) {
		...
		String functionName = attrHtmlId + "_from_" + valueAttrId.replace(".", "_") + "_cardLinkPickerDisabler";
		String getControlExpression = "dijit.byId('" + attrHtmlId + "_select')";
		String lookupBtn = "dijit.byId('" + attrHtmlId + "_lookupBtn')";

		stringBuilder.append("function " + functionName + "(attrCode, attrHtmlId, isInline, value, param) { ");
		if (values != null) {
			stringBuilder.append(getControlExpression + ".setDisabled(");
			addCheckValuesExpression(values, valuesToEnable, stringBuilder);
			stringBuilder.append(");");
			
			stringBuilder.append(lookupBtn + ".setDisabled(");
			addCheckValuesExpression(values, valuesToEnable, stringBuilder);
			stringBuilder.append(");");
		}
		else {
			stringBuilder.append(getControlExpression + ".setDisabled(value == null || typeof(value) == 'undefined' || value == '');");
			
			stringBuilder.append(lookupBtn + ".setDisabled(value == null || typeof(value) == 'undefined' || value == '');");
		}
		stringBuilder.append("}");
