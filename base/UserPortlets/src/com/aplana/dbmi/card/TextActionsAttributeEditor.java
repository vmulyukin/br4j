...
public class TextActionsAttributeEditor extends
		ActionsSupportingAttributeEditor {
	
	public TextActionsAttributeEditor() {
		setParameter(PARAM_JSP, "/WEB-INF/jsp/html/attr/TextActions.jsp");
	}
