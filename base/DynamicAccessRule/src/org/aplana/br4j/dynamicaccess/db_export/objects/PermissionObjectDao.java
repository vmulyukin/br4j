...
public abstract class PermissionObjectDao extends BaseAccessDao{

    protected PermissionObjectDao(Connection connection) {
        super(connection);
    }

    public abstract void insertObject() throws SQLException;
}
