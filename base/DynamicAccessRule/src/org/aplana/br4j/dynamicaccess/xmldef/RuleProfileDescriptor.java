...
/**
 * Class RuleProfileDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class RuleProfileDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public RuleProfileDescriptor() {
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                RuleProfile target = (RuleProfile) object;
        ...
        //-- _profileAttributeCode
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_profileAttributeCode", "profileAttributeCode", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                RuleProfile target = (RuleProfile) object;
                return target.getProfileAttributeCode();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    RuleProfile target = (RuleProfile) object;
                    target.setProfileAttributeCode( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _profileAttributeCode
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            StringValidator typeValidator = new StringValidator();
        ...
        desc.setValidator(fieldValidator);
        //-- _targetAttributeCode
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_targetAttributeCode", "targetAttributeCode", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                RuleProfile target = (RuleProfile) object;
                return target.getTargetAttributeCode();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    RuleProfile target = (RuleProfile) object;
                    target.setTargetAttributeCode( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _targetAttributeCode
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
            StringValidator typeValidator = new StringValidator();
            typeValidator.setWhiteSpace("preserve");
        ...
        desc.setValidator(fieldValidator);
        //-- _linkAttributeCode
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_linkAttributeCode", "linkAttributeCode", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                RuleProfile target = (RuleProfile) object;
                return target.getLinkAttributeCode();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    RuleProfile target = (RuleProfile) object;
                    target.setLinkAttributeCode( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _linkAttributeCode
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
            StringValidator typeValidator = new StringValidator();
            typeValidator.setWhiteSpace("preserve");
    ...
    } //-- org.aplana.br4j.dynamicaccess.xmldef.RuleProfileDescriptor()
    ...
    {
        return org.aplana.br4j.dynamicaccess.xmldef.RuleProfile.class;
