 ...
 */
public class RuleDelegation implements java.io.Serializable {
    ...
    public RuleDelegation() {
        super();
    } //-- org.aplana.br4j.dynamicaccess.xmldef.RuleDelegation()
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (org.aplana.br4j.dynamicaccess.xmldef.RuleDelegation) Unmarshaller.unmarshal(org.aplana.br4j.dynamicaccess.xmldef.RuleDelegation.class, reader);
	...
	public boolean equals(Object object) {
		if (!(object instanceof RuleDelegation)) {
			return false;
		}
		RuleDelegation anotherRuleDelegation = (RuleDelegation) object;
		return new EqualsBuilder()
			.append(getLinkAttributeCode(), anotherRuleDelegation.getLinkAttributeCode())
			.isEquals();
	}
    ...
    public String toString() {
    	...
    	append((getLinkAttributeCode()!=null&&!getLinkAttributeCode().isEmpty())?getLinkAttributeCode():AccessRule.EMPTY_STRING);
