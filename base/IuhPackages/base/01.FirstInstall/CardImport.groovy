...
@Log4j
public class CardImport extends AbstractExecute
{
    public void install()
    {
        log.info "Stamp is running... "
        File exampleProperties = new File(getParam(CommonParameters.System.JBOSS_CONFIGURATION_PATH)
                + File.separator + 'conf' + File.separator + 'dbmi' + File.separator + 'cardImport' + File.separator + 'card_import_config.properties.example');
        File fileProperties = new File(getParam(CommonParameters.System.JBOSS_CONFIGURATION_PATH)
                + File.separator + 'conf' + File.separator + 'dbmi' + File.separator + 'cardImport' + File.separator + 'card_import_config.properties');
