...
@Log4j
public class ChangeAttributeConf extends AbstractExecute
{
    public void install()
    {
        log.info "ChangeAttributeConf is running... "
        File exampleProperties = new File(getParam(CommonParameters.System.JBOSS_CONFIGURATION_PATH)
                + File.separator + 'conf' + File.separator + 'dbmi' + File.separator + 'ChangeAttributeConfig.xml.example');
        File fileProperties = new File(getParam(CommonParameters.System.JBOSS_CONFIGURATION_PATH)
                + File.separator + 'conf' + File.separator + 'dbmi' + File.separator + 'ChangeAttributeConfig.xml');
