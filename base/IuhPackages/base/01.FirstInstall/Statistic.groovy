 ...
 */
@Log4j
class Statistic extends AbstractExecute
{
    public void install()
    {
        log.info "Statistic is running... "
        File exampleProperties = new File(getParam(CommonParameters.System.JBOSS_CONFIGURATION_PATH)
                + File.separator + 'conf' + File.separator + 'dbmi' + File.separator + 'statistics' + File.separator + 'docs_statistic_config.properties.example');
