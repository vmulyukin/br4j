...
@Log4j
public class Mailer extends AbstractExecute
{
    public void install()
    {
        log.info "Stamp is running... "
        File exampleProperties = new File(getParam(CommonParameters.System.JBOSS_CONFIGURATION_PATH)
                + File.separator + 'conf' + File.separator + 'dbmi' + File.separator + 'mail' + File.separator + 'mailerConfig_ru.properties.example');
        File fileProperties = new File(getParam(CommonParameters.System.JBOSS_CONFIGURATION_PATH)
                + File.separator + 'conf' + File.separator + 'dbmi' + File.separator + 'mail' + File.separator + 'mailerConfig_ru.properties');
