...
public class NotificationCardIdConverter extends CardConverter {

    public NotificationCardIdConverter(Properties properties, String name) {
	...
	if (!"".equals(uidValue)) {
		...
		id = new DistributionItemCardHandler(uid).getCardId();
