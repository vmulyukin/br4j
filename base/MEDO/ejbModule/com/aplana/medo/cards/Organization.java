 ...
 *
 */
public class Organization extends ExportCardHandler {
    ...
    public Organization(ObjectId card_id) throws DataException,
    ServiceException {
	...
	if (card != null) {
	    ...
	    throw new CardException("jbr.medo.card.Organization.notFound");
	logger.info("Create object Organization with current parameters: "
