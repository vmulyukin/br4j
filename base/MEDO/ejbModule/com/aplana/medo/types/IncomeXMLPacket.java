...
@XmlTransient
public class IncomeXMLPacket extends XMLPacket {

    protected String outNumber;
    protected DeliveryMethod deliveryMethod = DeliveryMethod.MEDO;
    protected ImportedDocument importedDocument;

    public static enum DeliveryMethod {
	MEDO
    }

    public IncomeXMLPacket() {
	super();
    }

    public IncomeXMLPacket(XMLPacket packet) {
	super(packet);
    }
