 ...
 * element interface generated in the com.aplana.medo.types.document package.
 * <p>
...
public class ObjectFactory {
    ...
    private final static QName _DocumentNumberDate_QNAME = new QName(
	    "http://www.infpres.com/IEDMS", "date");
    private final static QName _DocumentClauseDesignation_QNAME = new QName(
	    "http://www.infpres.com/IEDMS", "designation");
    private final static QName _DeliveryDestinationFiles_QNAME = new QName(
	    "http://www.infpres.com/IEDMS", "files");
    private final static QName _DictionaryClientsEntryStartDate_QNAME = new QName(
	    "http://www.infpres.com/IEDMS", "startDate");
    private final static QName _DictionaryClientsEntryComment_QNAME = new QName(
	    "http://www.infpres.com/IEDMS", "comment");

    /**
     * Create a new ObjectFactory that can be used to create new instances of
     * schema derived classes for package: com.aplana.medo.types.document
     *
     */
     ...
     * {@link com.aplana.medo.types.document.Document.Enclosures }
     *
     */
    public com.aplana.medo.types.document.Document.Enclosures createDocumentEnclosures() {
	return new com.aplana.medo.types.document.Document.Enclosures();
    }
    ...
    /**
     * Create an instance of
     * {@link com.aplana.medo.types.document.Document.Addressees }
     *
     */
    public com.aplana.medo.types.document.Document.Addressees createDocumentAddressees() {
	return new com.aplana.medo.types.document.Document.Addressees();
    }
    ...
    /**
     * Create an instance of {@link com.aplana.medo.types.document.Document }
     *
     */
    public com.aplana.medo.types.document.Document createDocument() {
	return new com.aplana.medo.types.document.Document();
    }
    ...
    /**
     * Create an instance of
     * {@link com.aplana.medo.types.document.Document.Clauses }
     *
     */
    public com.aplana.medo.types.document.Document.Clauses createDocumentClauses() {
	return new com.aplana.medo.types.document.Document.Clauses();
    }
    ...
    /**
     * Create an instance of
     * {@link com.aplana.medo.types.document.Document.Links }
     *
     */
    public com.aplana.medo.types.document.Document.Links createDocumentLinks() {
	return new com.aplana.medo.types.document.Document.Links();
    }
    ...
    /**
     * Create an instance of
     * {@link com.aplana.medo.types.document.Document.Correspondents }
     *
     */
    public com.aplana.medo.types.document.Document.Correspondents createDocumentCorrespondents() {
	return new com.aplana.medo.types.document.Document.Correspondents();
    }
    ...
    /**
     * Create an instance of
     * {@link com.aplana.medo.types.document.Document.Signatories }
     *
     */
    public com.aplana.medo.types.document.Document.Signatories createDocumentSignatories() {
	return new com.aplana.medo.types.document.Document.Signatories();
    }
    ...
    public JAXBElement<XMLGregorianCalendar> createDocumentNumberDate(
	    XMLGregorianCalendar value) {
	return new JAXBElement<XMLGregorianCalendar>(_DocumentNumberDate_QNAME,
		XMLGregorianCalendar.class, DocumentNumber.class, value);
    }
	...
	return new JAXBElement<String>(_DocumentClauseDesignation_QNAME,
		String.class, DocumentClause.class, value);
    }
    ...
    public JAXBElement<List<BigInteger>> createDeliveryDestinationFiles(
	    List<BigInteger> value) {
	return new JAXBElement<List<BigInteger>>(
		_DeliveryDestinationFiles_QNAME, ((Class) List.class),
		DeliveryDestination.class, (value));
    }
    ...
    public JAXBElement<XMLGregorianCalendar> createDictionaryClientsEntryStartDate(
	    XMLGregorianCalendar value) {
	return new JAXBElement<XMLGregorianCalendar>(
		_DictionaryClientsEntryStartDate_QNAME,
		XMLGregorianCalendar.class, Dictionary.Clients.Entry.class,
		value);
    }
	...
	return new JAXBElement<String>(_DictionaryClientsEntryComment_QNAME,
		String.class, Dictionary.Clients.Entry.class, value);
    }
