...
public interface NotificationDevice {
	...
	//public boolean sendNotification(Person recipient, String message, Map<String, Object> properties);
	
	//public boolean sendNotification(String recipient, String message, Map<String, Object> properties);
