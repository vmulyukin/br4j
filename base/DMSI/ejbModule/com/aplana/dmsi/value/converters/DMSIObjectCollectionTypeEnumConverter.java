...
import com.aplana.dmsi.types.CollectionEnumType;
import com.aplana.dmsi.types.DMSIObject;
import com.aplana.dmsi.types.common.AuthType;

public class DMSIObjectCollectionTypeEnumConverter extends DMSIObjectEnumConverter {

    @Override
    protected Enum<?> getValueOf(String value) {
        return CollectionEnumType.valueOf(value);
    }
