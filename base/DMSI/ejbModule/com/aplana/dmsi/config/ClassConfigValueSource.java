...
public class ClassConfigValueSource extends ValueSource {
    private ClassConfig config;

    public ClassConfigValueSource(ClassConfig config, boolean isReadOnly) {
	super(isReadOnly);
	this.config = config;
    }
	...
	attributeIds.addAll(config.getRequiredAttributes());
	return attributeIds;
    }
}