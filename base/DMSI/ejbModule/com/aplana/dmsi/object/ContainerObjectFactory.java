...
public abstract class ContainerObjectFactory extends EntityFactory {

    @Override
    protected Object newDMSIObject(Card card) throws DMSIException {
	Object containedObject = super.newDMSIObject(card);
	ContainerObject containerObject = newContainerObject();
	containerObject.setContainedObject(containedObject);
	return containerObject;
    }

    protected abstract ContainerObject newContainerObject()
