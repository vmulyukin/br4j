...
class TreeAttributeHandler extends AttributeHandler {

    private Log logger = LogFactory.getLog(getClass());

    public TreeAttributeHandler(Attribute attribute, DataServiceFacade serviceBean) {
	super(attribute, serviceBean);
    }

    @Override
    public Object getAttributeValue() {
	return ((TreeAttribute) getAttribute()).getStringValue();
    }
