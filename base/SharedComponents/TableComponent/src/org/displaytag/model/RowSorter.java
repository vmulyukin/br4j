 ...
 * @version $Revision: 923 $ ($Author: fgiust $)
 */
public class RowSorter implements Comparator
{
    ...
    public final int compare(Object object1, Object object2)
    {
        ...
        Object obj2 = null;
// dgashkov
        // if property is null compare using two cell objects
        if (this.property == null)
        {
        	Object 
        		tmp1 = ((Row) object1).getObject(), 
        		tmp2 = ((Row) object1).getObject();
        	if ((tmp1 instanceof ArrayList) && (tmp2 instanceof ArrayList)) {
                if (object1 instanceof Row) {
                    obj1 = ((ArrayList)tmp1).get(this.columnIndex);
                }
                if (object2 instanceof Row) {
                    obj2 = ((ArrayList)tmp2).get(this.columnIndex);
                }
