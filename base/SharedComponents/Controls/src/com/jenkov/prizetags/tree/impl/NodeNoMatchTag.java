...
public class NodeNoMatchTag extends NodeBaseTag{
    ...
    /**
     *  Note: Returning false when an attribute is not set,
     *  is different than the matches() in the nodeMatch tag.
     *
     *  If an attribute is not set in the nodeNoMatch tag,
     *  it should be ignored. This is done by returning false,
     *  e.g. that it is not a match.
     *
     */
    protected boolean matches(String attribute, String value){
        if(attributeNotSet(attribute)) return false;
