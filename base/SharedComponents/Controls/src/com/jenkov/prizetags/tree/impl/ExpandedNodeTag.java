...
public class ExpandedNodeTag extends TagSupport{
    protected String tree           = null;
    protected String expandParam    = null;
    protected String expandedNode   = null;
    ...
    public String getExpandParam() {
        if(expandParam == null) return "expand";
        return expandParam;
    }
    ...
    public void setExpandedNode(String expandedNode) {
    ...
    public int doStartTag() throws JspException {
        ...
        if(expandId != null){
            ...
            pageContext.getRequest().setAttribute(getExpandedNode(), tree.findNode(expandId));
        }
