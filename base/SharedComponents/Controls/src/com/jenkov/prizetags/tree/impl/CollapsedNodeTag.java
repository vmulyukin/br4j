...
public class CollapsedNodeTag extends TagSupport{
    protected String tree            = null;
    protected String collapseParam   = null;
    protected String collapsedNode   = null;
    ...
    public String getCollapseParam() {
        if(collapseParam == null) return "collapse";
    ...
    public String getCollapsedNode() {
        return collapsedNode;
    }

    public void setCollapsedNode(String collapsedNode) {
    ...
    public int doStartTag() throws JspException {
        ...
        if(collapseId != null){
            ...
            pageContext.getRequest().setAttribute(getCollapsedNode(), tree.findNode(collapseId));
        }
