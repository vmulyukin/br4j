...
public class CopyChangesFromLocalCardWithMaterial extends CopyChangesFromLocalCard {

	@Override
	protected void afterDestinationCardSaved() throws DataException, ServiceException, JAXBException, IOException {
		super.afterDestinationCardSaved();
		CopyMaterial copyMaterial = new CopyMaterial();
		copyMaterial.setFromCardId(getChangedCard().getId());
		copyMaterial.setToCardId(getDestinationCardId());
		getDataService().doAction(copyMaterial);
	}
}
