...
@XmlType(name = "WSO_TASK_WITH_REPORTS", propOrder = { "comments", "attachments", "reports",
	"zamExecutors", "viewers", "dateFact", "dateSign" })
public class WSOTaskWithReports extends WSOMTask {
