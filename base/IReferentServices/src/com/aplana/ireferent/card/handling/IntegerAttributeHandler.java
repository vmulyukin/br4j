...
class IntegerAttributeHandler extends AttributeHandler {
	...
	return BigInteger.valueOf(((IntegerAttribute) attribute).getValue());
    }

    @Override
    public void setAttributeValue(Object value) {
	if (value instanceof Integer) {
	    ((IntegerAttribute) attribute).setValue((Integer) value);
	} else if (value instanceof BigInteger) {
	    ((IntegerAttribute) attribute).setValue(((BigInteger) value)
		    .intValue());
	} else {
