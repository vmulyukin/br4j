...
public class GetResolutionsOperation implements ServiceOperation<WSOWrapper> {
    ...
    public GetResolutionsOperation(String docId, boolean isMObject, boolean isTree,
