...
@WebService(name = "WS_SearchManager", targetNamespace = "urn:DefaultNamespace")
@SOAPBinding(style = SOAPBinding.Style.RPC)
public interface SearchManager {
	
	@WebMethod(operationName = "GETFAVORITES")
    @WebResult(name = "WSO_SEARCHRESULT", partName = "WSO_SEARCHRESULT")
    WSOSearchResult getFavorites(
    	@WebParam(name = "ISMOBJECT", partName = "ISMOBJECT")
    	boolean isMObject,
    	@WebParam(name = "INCLUDEATTACHMENTS", partName = "INCLUDEATTACHMENTS")
    	boolean includeAttachments,
	    @WebParam(name = "SEARCHREQUEST", partName = "SEARCHREQUEST")
	    WSOSearchRequest searchRequest,
