...
import com.aplana.ireferent.value.converters.ReportValuePartConverter;

public class ReportValueFactory implements ControllerFactory {

    public ValueController newController() {
	return new ReportXMLValueController();
    }
