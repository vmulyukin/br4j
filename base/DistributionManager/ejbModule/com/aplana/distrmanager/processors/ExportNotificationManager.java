...
public class ExportNotificationManager extends ProcessCard {
    ...
    private static final String STATE_CARD_ERROR = "jbr.DistributionManager.ExportNotificationManager.errorCreateStateCard";
    private static final String BACKLINK_DOCBASE_ERROR = "jbr.DistributionManager.ExportNotificationManager.notFound.backLinkDocBase";
    private static final String NONCRITICAL_ERROR = "jbr.DistributionManager.ExportNotificationManager.noncriticalError";
    private static final String SUCCESSFUL = "jbr.DistributionManager.ExportNotificationManager.SUCCESSFUL";
    private static final String WRITE_RESULT_ERROR_CRITICAL = "jbr.DistributionManager.ExportNotificationManager.WriteResult.Rollback";
    private static final String SAVE_CARD_ERROR_CRITICAL = "jbr.DistributionManager.ExportNotificationManager.SaveCard.Rollback";
    private static final String CHANGE_STATE_ERROR_CRITICAL = "jbr.DistributionManager.ExportNotificationManager.ChangeStatus.Rollback";
    private static final String ERROR_CRITICAL = "jbr.DistributionManager.ExportNotificationManager.doProcess.CriticalError.Rollback";
    ...
    public Object process() throws DataException {
        try {
            ...
            NoticeGOST noticeGostWrap = WrapperCardsFactory.instance(serviceBean).createNoticeGost(elmCardWrap, msgGOSTWrap, docBase, getAction());
            noticeGostId = noticeGostWrap == null ? null : noticeGostWrap.getId();

            logError(card, SUCCESSFUL, null);

        } catch (DocBaseException dbe) {
            logError(currentCard, BACKLINK_DOCBASE_ERROR, dbe);
            throw new DataException(BACKLINK_DOCBASE_ERROR);

        } catch (StateCardException sce) {
            logError(currentCard, STATE_CARD_ERROR, sce);
            throw new DataException(STATE_CARD_ERROR);
            ...
            throw new DistributionManagerException(ERROR_CRITICAL);
        }
        return null;
    }
