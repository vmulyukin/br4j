...
<body>
<p><b>Срок истек!</b> Уведомление Системы "Корпоративная база маркетинговой информации МТС"</p>
<p>Срок исполнения истек по следующим задачам:<br>
...
<td>${(card.getAttributeById(util.makeId('PersonAttribute', "request.customer")).stringValue)!"(Инкогнито)"}</td>
<td>${(card.getAttributeById(util.makeId('DateAttribute', "request.estimated")).stringValue)!"(Не задан)"}</td>
</tr>
</#list>
</table>
</p>
