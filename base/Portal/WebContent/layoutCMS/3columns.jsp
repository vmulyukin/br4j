				...
				<td valign="top">
					<table border="0" cellpadding="0" width="100%">
						<tr>
							...
							<td class="regionCenter-top" colspan="3"/>
						</tr>
						<tr>
							...
							<td class="regionRight-left"/>
							<td width="190px" valign="top" class="regionRight-content"><p:region regionName="right" regionID="regionRight"/></td>
						</tr>
						<tr>
							<td class="regionCenter-bottomLeft"/>
							<td class="regionCenter-bottom" colspan="3"/>
						</tr>
					</table>
				</td>			
			</tr>
